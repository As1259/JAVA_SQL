...
import de.as1259.sql.connectors.MSSQLConnector;

import java.sql.ResultSet;

/**
 * Singleton Class for the Microsoft SQL Conncetion
 */
@Deprecated
public class MSSQLConnection {
    ...
    private  static MSSQLConnector sqlConn;
    ...
    public static void open(String address, int port, String database,String user,
        ...
        sqlConn =  new MSSQLConnector(address,port,database,user,password,ssl);
    }
